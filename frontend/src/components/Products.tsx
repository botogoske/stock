        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="flex space-x-2">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 py-2.5 bg-linear-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-semibold rounded-xl text-sm transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 shadow-md shadow-violet-200/50"
            >
              {isLoading ? (
                <>
                  ...
                  <tr key={p.id} className="hover:bg-slate-50 transition-all duration-150">
                    <td className="py-3 pl-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 rounded-full bg-amber-100 border border-amber-300 text-amber-600 font-bold flex items-center justify-center text-xs shrink-0">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="min-w-0">
                          ...
                          {p.description && (
                            <p className="text-[10px] text-slate-400 truncate max-w-50">{p.description}</p>
                          )}
                        </div>
                      </div>
                    </td>
